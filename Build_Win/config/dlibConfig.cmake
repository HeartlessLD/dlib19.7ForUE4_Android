...
find_library(dlib_LIBRARIES dlib HINTS "C:/Program Files (x86)/dlib/lib")
set(dlib_LIBRARIES ${dlib_LIBRARIES} "ws2_32;winmm;comctl32;gdi32;imm32")
set(dlib_LIBS      ${dlib_LIBRARIES} "ws2_32;winmm;comctl32;gdi32;imm32")
set(dlib_INCLUDE_DIRS "C:/Program Files (x86)/dlib/include" "")

include(C:/Program Files (x86)/dlib/include/dlib/cmake_utils/use_cpp_11.cmake)
